...
public class Main {
    ...
    private static URL getUrl(String stationCode) throws MalformedURLException {
        ...
        var scheme = "https";
        var domain = "dd.weather.gc.ca";
        var path = "/hydrometric/csv/ON/daily/ON_" + stationCode +"_daily_hydrometric.csv";
    ...
    public static void main(String[] args) throws ParseException {
        ...
        try (var provider = new StationDataProvider(url)) {
            ...
            if(cmd.hasOption('a')){
                var avg = analyzer.averageWaterLevel();
            ...
            if(cmd.hasOption('g')){
                var chart = analyzer.createChart();
                BitmapEncoder.saveBitmapWithDPI(chart, "mychart.png", BitmapEncoder.BitmapFormat.PNG, 300);
            }
